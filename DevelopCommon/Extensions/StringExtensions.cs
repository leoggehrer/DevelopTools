...
namespace DevelopCommon.Extensions
{
    public static class StringExtensions
    {
        ...
        public static string NullText { get; } = "<NULL>";
        ...
        public class TagInfo
        {
            ...
            public IEnumerable<string> GetFullLines()
            {
                var data = string.Empty;
                var lineEndIdx = Source.IndexOf(Environment.NewLine, EndTagIndex) - 1;

                data = Source.Partialstring(StartTagIndex, EndTagIndex - 1);
                data = data + Source.Partialstring(EndTagIndex, lineEndIdx);
                return data.ToLines();
            }
        ...
        public static IEnumerable<TagInfo> GetAllTags(this string text, string[] tags)
        {
            ...
            for (int i = 0; i + 1 < tags.Length; i = i + 2)
            {
            ...
            where T : TagInfo, new()
        {
            ...
            var tagHeader = new TagHeader() { Source = text };
            ...
            do
            {
                ...
                var endTagEndIndex = endTagIndex > -1 ? endTagIndex + endTag.Length - 1 : parseIndex;
                ...
                if (startTagIndex > -1 && endTagIndex > startTagIndex)
                {
                    ...
                    if (endTagSearchPosAt > endTagIndex && blockCounter.Sum() == 0)
                    {
                        ...
                        endTagEndIndex = endTagIndex + endTag.Length - 1;
                    }
                }
        ...
        /// <summary>
        /// Diese Methode fuegt einem String-Array n Einzuege hinzu.
        /// </summary>
        /// <param name="lines">String-Array, welchem die Einzuege hinzugefuegt werden.</param>
        /// <param name="count">Anzahl der Einzuege die dem String-Array hinzugefuegt werden.</param>
        /// <returns>String-Array mit Anzahl von Einzuegen.</returns>
        ...
        /// <summary>
        /// Diese Methode konvertiert ein String-Array zu einem zusammenhaengenden Text.
        /// </summary>
        /// <param name="lines">Das String-Array.</param>
        /// <returns>Text aus dem String-Array.</returns>
        ...
        /// <summary>
        /// Diese Methode konvertiert einen Text mit Zeilenumbrueche in ein String-Array.
        /// </summary>
        /// <param name="text">Der zu konvertierende Text</param>
        /// <returns>String-Array aus dem Text.</returns>
        ...
        public static string Partialstring(this string text, string from, string to)
        {
            ...
            if (string.IsNullOrEmpty(text) == false)
            {
                int idxFrom = text.IndexOf(from);

                if (idxFrom >= 0)
                {
                    idxFrom = idxFrom + from.Length;
                    int idxEnd = text.IndexOf(to, idxFrom + 1);
                    for (int i = idxFrom; i >= 0 && i < idxEnd && i < text.Length; i++)
                    {
                        sb.Append(text[i]);
                    }
                }
        ...
        public static string Remove(this string text, string startTag, string endTag)
        {
            ...
            do
            {
                ...
                if (startTagIndex > -1 && endTagIndex > startTagIndex)
                {
                    result.Append(text.Substring(parseIndex, startTagIndex - parseIndex));
            ...
            {
                result.Append(text.Substring(parseIndex, text.Length - parseIndex));
            }
        ...
        public static IEnumerable<T> ToEnumerable<T>(this string source)
        {
